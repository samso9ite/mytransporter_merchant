                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                   <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span class="badge light text-white bg-secondary rounded-circle">0</span>
                                </a>
				...
				<ul class="metismenu" id="menu">
					...
					<li>
						<router-link :to="'/teams'"> 
							<a href="customer.html" class="ai-icon" aria-expanded="false">
                    ...
                    <li>
						<router-link :to="'/orders'"> 
							<a class="ai-icon" href="order-list.html" aria-expanded="false">
                    ...
                    <li>
						<router-link :to="'/rate'"> 
							<a class="ai-icon" href="rate_settings.html" aria-expanded="false">
